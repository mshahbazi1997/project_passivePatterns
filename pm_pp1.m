...
pm_def.INPUT_DATA_FORMAT = 'PM';      % 'RI' = load two real and 
                                      ...
                                      % pairs.
pm_def.SHORT_ECHO_TIME = 4.08;        % Short echo time in ms for Allegra
pm_def.LONG_ECHO_TIME = 5.1;        % Long echo time in ms for Allegra
...
pm_def.TOTAL_EPI_READOUT_TIME = 49.3;   % EPI RO time (330E-6*64)
